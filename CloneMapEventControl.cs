...
{
    [Rm2k3CmdControl(2056, "Ghabry", "Clone Map Event", "Clone Map Event")]
    public partial class CloneMapEventControl : SingleCommandControl
    {
        public CloneMapEventControl()
        {
            InitializeComponent();
        }
        public CloneMapEventControl(List<EventCommand> _ev) : base(_ev, (cmdcs.Code)2056, "")
        {
            InitializeComponent();
            ...
            rmSelectVariableEx6.StringValue = TargetCommand.Text;
